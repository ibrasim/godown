    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <h5>ORDER LIST -DRAFT 28 OCT 25  | aprox (AED 5,700.00  | US$ 1,583.33  | MVR 31,666.67)</h5>
                    <h5>SUPPLIER : UAE-COSM-SHA-2025-02 |  FREIGHTFORWARDER: XXX </h5>
                     <a class="nav-link" href="{{route('uaelistparisp')}}">GO TO ORDER LIST 2 UAE</a>
                ...
                <tbody>
                    ...
                    <tr class="hover:bg-gray-50">
                     ...
                     <tr class="hover:bg-gray-50">
                        ...
                        <td class="border border-gray-300 px-4 py-2">VASELINE P. JELLY 50 ML</td>
                        <td class="border border-gray-300 px-4 py-2">1X288 PCS </td>
                        <td class="border border-gray-300 px-4 py-2">1 CTN</td>
                        <td class="border border-gray-300 px-4 py-2">510.00</td>
                         <td class="border border-gray-300 px-4 py-2">510.00</td>
                     ...
                     <tr class="hover:bg-gray-50">
                       ...
                       <tr class="hover:bg-gray-50">
                        ...
                        <td class="border border-gray-300 px-4 py-2">GILLETTE SHAVING GEL 200 ML</td>
                        <td class="border border-gray-300 px-4 py-2">1X12 PCS </td>
                        <td class="border border-gray-300 px-4 py-2">1 CTN</td>
                        <td class="border border-gray-300 px-4 py-2">80.00</td>
                         <td class="border border-gray-300 px-4 py-2">80.00</td>
                      ...
                      <tr class="hover:bg-gray-50">
                        ...
                        <td class="border border-gray-300 px-4 py-2">LIFEBUOY SOAP 125 GM</td>
                        <td class="border border-gray-300 px-4 py-2">1X144 PCS </td>
                        <td class="border border-gray-300 px-4 py-2">1 CTN</td>
                     ...
                     <tr class="hover:bg-gray-50">
                        ...
                        <td class="border border-gray-300 px-4 py-2">DOVE SOAP 135 GM</td>
                        <td class="border border-gray-300 px-4 py-2">1X48 PCS </td>
                        <td class="border border-gray-300 px-4 py-2">1 CTN</td>
                       ...
                       <tr class="hover:bg-gray-50">
                        ...
                        <td class="border border-gray-300 px-4 py-2">DOVE SOAP 90 GM</td>
                        <td class="border border-gray-300 px-4 py-2">1X48 PCS </td>
                        <td class="border border-gray-300 px-4 py-2">1 CTN</td>
                        <td class="border border-gray-300 px-4 py-2">93.00</td>
                         <td class="border border-gray-300 px-4 py-2">93.00</td>
                     ...
                     <tr class="hover:bg-gray-50">
                        ...
                        <td class="border border-gray-300 px-4 py-2"> LIFEBUOY BODY WASH 500 ML</td>
                        <td class="border border-gray-300 px-4 py-2">1X12 PCS </td>
                        <td class="border border-gray-300 px-4 py-2">1 CTN</td>
                        <td class="border border-gray-300 px-4 py-2">102.00</td>
                         <td class="border border-gray-300 px-4 py-2">102.00</td>
